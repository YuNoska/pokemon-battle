...
[トップへ](../README.md) ｜ [現行構築](current-team.md) ｜ [対戦記録](battle-log.md)

## おすすめの順番

**追記：サイクル要素を重視する希望を受け、現在の優先案は[回復・交代技を増やした構築](cycle-team.md)です。** 以下のA～Cは比較用に残します。
...
残り3匹の技・性格・配分・持ち物、全員の特性は[現行設定](current-team.md)を使います。能力補正で弱まるアクアジェットは、削れた相手を倒す補助用です。
