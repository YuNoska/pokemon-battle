...
| 名前 | 性格／持ち物 | 能力ポイント | 技 |
| --- | --- | --- | --- |
| グソクムシャ | いじっぱり（攻撃↑・特攻↓）／グソクムシャナイト | 29-14-0-0-0-23 | アイアンヘッド・きゅうけつ・ふいうち・つるぎのまい |
| ボーマンダ | むじゃき（素早さ↑・特防↓）／ボーマンダナイト | 0-19-0-15-0-32 | すてみタックル・りゅうせいぐん・だいもんじ・じしん |
| ヒートロトム | おくびょう（素早さ↑・攻撃↓）／こだわりスカーフ | 2-0-0-32-0-32 | オーバーヒート・10まんボルト・ボルトチェンジ・トリック |
| ガブリアス | ようき（素早さ↑・特攻↓）／きあいのタスキ | 1-32-1-0-0-32 | じしん・がんせきふうじ・ドラゴンテール・ステルスロック |
| アシレーヌ | ずぶとい（防御↑・攻撃↓）／オボンのみ | 32-0-32-1-0-1 | うたかたのアリア・ムーンフォース・アクアジェット・アンコール |
| サーフゴー | ひかえめ（特攻↑・攻撃↓）／ふうせん | 22-0-0-32-0-12 | ゴールドラッシュ・シャドーボール・わるだくみ・じこさいせい |
...
| ガブリアス | しんちょう（特防↑・特攻↓）・特防重視・オボン | ようき（素早さ↑・特攻↓）AS・タスキ | 行動機会と速さ／特殊への耐久を失う |
| アシレーヌ | ひかえめ（特攻↑・攻撃↓）・残飯・HB重視 | ずぶとい（防御↑・攻撃↓）HB・オボン | 物理耐久と即時回復／特殊火力が低下 |
